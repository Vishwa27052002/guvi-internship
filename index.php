            ...
            <div class="login-panel panel panel-primary">
            	...
            	<div class="panel-body">
                	<form role="form" id="signform">
                    	<fieldset>
						<div class="form-group">
                            	<input class="form-control" placeholder="first name" name="sfirstname" id="sfirstname" type="text" autofocus>
                        	</div>
							<div class="form-group">
                            	<input class="form-control" placeholder="lastname" name="slastname" id="slastname" type="text" autofocus>
                        	</div>
                        	<div class="form-group">
							...
							<div class="form-group">
                            	<input class="form-control" placeholder="phone no" name="sphoneno" id="sphoneno" type="text" autofocus>
                        	</div>
							<div class="form-group">
                            	<input class="form-control" placeholder="email id" name="semail" id="semail" type="text">
                        	</div>
